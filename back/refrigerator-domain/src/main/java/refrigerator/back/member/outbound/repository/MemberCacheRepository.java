package refrigerator.back.member.outbound.repository;
...
import refrigerator.back.member.outbound.cache.MemberCacheKey;
...
public class MemberCacheRepository {
    ...
    private final OutMemberMapper memberDtoMapper;
    private final RedisCacheManager redisCacheManager;

    public MemberCacheRepository(MemberRepository repository,
                                 OutMemberMapper memberDtoMapper,
