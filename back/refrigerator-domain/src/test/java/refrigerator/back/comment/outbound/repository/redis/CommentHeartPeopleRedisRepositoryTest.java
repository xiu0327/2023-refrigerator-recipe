...
class CommentHeartPeopleRedisRepositoryTest {
    ...
    void findByCommentIdAndMemberId() {
        // given
        CommentHeartPeople people = new CommentHeartPeople(1L, 1L, "email");
    ...
    void findByMemberId(){
        // given
        CommentHeartPeople people1 = new CommentHeartPeople(1L, 1L, "email");
        CommentHeartPeople people2 = new CommentHeartPeople(2L, 2L, "email");
