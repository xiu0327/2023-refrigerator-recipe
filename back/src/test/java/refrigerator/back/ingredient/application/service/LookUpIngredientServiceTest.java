...
class LookUpIngredientServiceTest {
    ...
    void before() {
        ingredientService.registerIngredient("당근", LocalDate.of(2023, 3, 30),
                10, "개", "냉장", "test.png","ehgus5825@naver.com");
        ingredientService.registerIngredient("고구마", LocalDate.of(2023, 3, 24),
                20, "개", "냉장", "test.png","ehgus5825@naver.com");
    ...
    void 식재료_검색() {
        ...
        ingredientService.registerIngredient("쌀!!!!", LocalDate.of(2020, 5, 6),
                60, "g", "실온", "test.png","ehgus5825@naver.com");
        ingredientService.registerIngredient("돼지고기!!!!", LocalDate.of(2023, 4, 7),
                70, "g", "냉동", "test.png","ehgus5825@naver.com");
    ...
    @Test
    void 식재료_단건_조회() {
        Long id = ingredientService.registerIngredient("돼지고기", LocalDate.of(2023, 4, 7),
                70, "g", "냉동", "test.png","ehgus5825@naver.com");
        ...
        assertThat(responseDTO.getExpirationDate().toString()).isEqualTo("2023-04-07");
        // assertThat(responseDTO.getWholeDays()).isEqualTo(7);
        // assertThat(responseDTO.getRemainDays()).isEqualTo(7);
        ...
        Long id1 = ingredientService.registerIngredient("소고기", LocalDate.of(2023, 4, 6),
                80, "g", "냉동", "test.png","ehgus5825@naver.com");
