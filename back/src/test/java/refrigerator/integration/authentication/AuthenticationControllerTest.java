...
import refrigerator.integration.authentication.web.dto.TemporaryAccessTokenRequestDTO;
...
class AuthenticationControllerTest {
    ...
    private final String email = "jktest101@gmail.com";
    ...
    void issueTemporaryToken() throws Exception {
        ...
        // given
        TemporaryAccessTokenRequestDTO request = TemporaryAccessTokenRequestDTO.builder()
                .email(email).build();
